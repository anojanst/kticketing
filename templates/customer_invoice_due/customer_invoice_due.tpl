	...
	<div class="row">
		<div class="panel panel-info" style="margin-top: 10px;">
			<div class="panel-heading">
				<strong>Search Customer Invoice Due</strong>
			</div>
			<div class="panel-body">
				<form role="form" action="customer_invoice_due.php?job=search" method="post">
					<div class="col-lg-3">
				...
				<div class="col-lg-2">
					<a href="customer_invoice_due.php?job=customer_invoice_due_print"  class="btn btn-primary" target="blank">Print</a>
				</div>
			</div>
		</div>
	</div>
