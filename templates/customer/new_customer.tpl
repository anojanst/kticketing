                ...
                <div class="panel-body">
            		<form name="add_product" action="customer.php?job=add" method="post" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-lg-4">
								<div class="form-group">
        							<input class="form-control" type="text" name="dob" value="{$dob}" placeholder="Date of Birth  (YYYY-MM-DD)">
								</div>
		                    </div>
							<div class="col-lg-4">
						...
						<div class="row">
							...
							<div class="col-lg-6">
		                    	<div class="form-group">
									<input class="form-control" type="file" name="passport" id="passport" value="{$passport}" placeholder="Passport"/>
		                   	 	</div>
		                	</div>
	                	</div>
						<div class="row">
							<div class="col-lg-6">
								<div class="form-group">
        							<input class="form-control" type="text" name="issued_date" value="{$issued_date}" placeholder="Issued Date  (YYYY-MM-DD)">
								</div>
		                    </div>
							<div class="col-lg-6">
								<div class="form-group">
    							<input class="form-control" type="text" name="expire_date" value="{$expire_date}" placeholder="Expire Date  (YYYY-MM-DD)">
								</div>
		                    </div>
	                	</div>
						<div class="row">
