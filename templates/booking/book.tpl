	...
	<script type="text/javascript">
        $(document).ready(function() {
            $('input.booking_no').typeahead({
                name: 'booking_no',
                remote : 'ajax/booking_no.php?query=%QUERY'
		...
		<div class="col-lg-12" style="margin-top: 10px;">
			<div class="panel panel-info" style="margin-top: 10px;">
				<div class="panel-heading">
					<strong>Search Confirmed Bookings</strong>
				</div>
				<div class="panel-body">
					<form role="form" action="book.php?job=search" method="post" name="add_item">
						<div class="col-lg-2">
							<div class="form-group">
								<input class="form-control booking_no" type="text" name="booking_no" placeholder="Booking No" />
							</div>
						</div>
						<div class="col-lg-3">
							<div class="form-group">
	...
	<div class="row">
		<div class="col-lg-12" style="margin-top: 10px;">
			<div class="panel panel-info">
				...
				<div class="panel-body">
                    {php}list_booking($_SESSION['search_booking_no'], $_SESSION['search_customer'], $_SESSION['from_date'], $_SESSION['to_date']);{/php}
				</div>
			</div>
		</div>
	</div>
