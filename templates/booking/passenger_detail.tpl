		...
		<div class="col-lg-12" style="margin-top: 10px;">
			<div class="panel panel-green" style="margin-top: 10px;">
                ...
                <div class="panel-body">
            		...
            		<form name="add_product" action="booking.php?job=add_passenger" method="post" enctype="multipart/form-data">
						<div class="row">
							<div class="col-lg-2">
							...
							<div class="col-lg-3">
		                    	<div class="form-group">
									<input class="form-control" type="file" name="visa_copy" id="visa_copy" value="{$visa_copy}" placeholder="Visa Copy"/>
		                   	 	</div>
		                	</div>
							<div class="col-lg-2">
		                    	<div class="form-group">
					...
					{/if}
					{php}list_passengers_details($_SESSION['booking_no']);{/php}
				</div>
            </div>
	    </div>
   </div>
		...
		<div class="col-lg-12" style="margin-top: 10px;">
			<div class="panel panel-red" style="margin-top: 10px;">
				...
				<div class="panel-footer">
            		<form name="add_product" action="booking.php?job=booking_complete" method="post">
						<div class="row">
							<div class="col-lg-3">
		                    	<div class="form-group">
									<strong>Add PNR & Complete Booking</strong>
		                   	 	</div>
		                	</div>
						</div>
						<div class="row">
							...
							<div class="col-lg-2">
		                    	<div class="form-group">
									<input class="form-control" type="text" name="transits" value="{$transits}" required placeholder="Transit"/>
		                   	 	</div>
		                	</div>
							<div class="col-lg-2">
		                    	<div class="form-group">
