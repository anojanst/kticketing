                ...
                <div class="panel-body">
            		<form name="booking_no_form" action="refund.php?job=booking_no_form" method="post">
						<div class="row">
							...
							<div class="col-lg-2">
								<div class="form-group">
									<button type="submit" name="ok" class="btn btn-success">Display Booking Details</button>
								</div>                 
                    		</div>
						</div>                 
                   </form>
                ...
                <div class="panel-body">
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="col-lg-2">
								<div class="form-group">
    								<div class="controls input-append date form_date" data-date-format="yyyy-mm-dd" data-link-field="dtp_input1">
        								<input type="text" name="apply_date" value="{$apply_date}" required="required" style="width: 100%;" placeholder="Apply Date">
							...
							<div class="col-lg-3">
		                    	<div class="form-group">
									<input class="form-control" type="file" name="letter" id="letter" value="{$letter}" required="required" placeholder="Refund Request Letter"/>
		                   	 	</div>
		                	</div>
							<div class="col-lg-12">
								<div class="form-group">
							...
							<div class="col-lg-3">
		                    	<div class="form-group" style="text-align: center;">
									<button type="submit" name="ok" value="Save & Select Passenger form Booking" class="btn btn-danger">Save & Select Passenger form Booking</button>
								</div>
		                	</div>
							</form> 
						</div>
