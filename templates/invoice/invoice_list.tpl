					...
					<form name="search_form" action="invoice.php?job=search" method="post"  >
						<div class="col-lg-2">
							<div class="form-group">
								<input class="form-control" type="text" name="invoice_no" placeholder="Ref No" />
							</div>
						</div>
						<div class="col-lg-3">
							<div class="form-group">
	...
	<div class="row">
		<div class="col-lg-12" style="margin-top: 10px;">
			<div class="panel panel-red">
				...
				<div class="panel-body">
                    {php}search_invoice($_SESSION['search_invoice_no'], $_SESSION['search_customer'], $_SESSION['from_date'], $_SESSION['to_date']);{/php}
				</div>
			</div>
		</div>
	</div>
