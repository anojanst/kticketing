					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-lg-12" style="margin-top: 10px;">
								...
								<div class="col-lg-3 alert-primary"> &nbsp;</div>
								<div class="col-lg-2 alert-primary">Total</div>
								<div class="col-lg-2 alert-primary"><strong>{$total}</strong></div>
								<div class="col-lg-2 alert-primary"> &nbsp;</div>
							</div>
						</div>
					</div>
				</div>
