                ...
                <div class="panel-body">
            		<form name="paybill_customer_form" action="paybill.php?job=customer_form" method="post" onsubmit="return checkTotal();">
						...
						<div class="col-lg-2">
		                    <div class="form-group" style="visibility:visible;">
    							<div class="controls input-append date form_date" data-date-format="yyyy-mm-dd" data-link-field="dtp_input1">
        							<input type="text" name="vsp_from_date" value="{$vsp_from_date}" readonly placeholder="From" style="width: 100%;">
						...
						<div class="col-lg-2">
		                    <div class="form-group" style="visibility:visible;">
    							<div class="controls input-append date form_date" data-date-format="yyyy-mm-dd" data-link-field="dtp_input1">
        							<input type="text" name="vsp_to_date" value="{$vsp_to_date}" readonly placeholder="To" style="width: 100%;">
        							<span class="add-on"><i class="icon-remove"></i></span>
									<span class="add-on"><i class="icon-th"></i></span>
    							</div>
								<input type="hidden" id="dtp_input1" value="" />
							...
							<div class="col-lg-3">
								<div class="form-group">
									<button type="submit" name="ok" class="btn btn-danger">List Pending Vouchers</button>
								</div>                 
                    		</div>				
						</div>                 
                   </form>
                ...
                <div class="panel-body">
					...
					<div class="row" style="margin-top: 20px;">
						...
						<div class="col-lg-2">
		                    <div class="form-group" style="visibility:visible;">
    							<div class="controls input-append date form_date" data-date-format="yyyy-mm-dd" data-link-field="dtp_input1">
        							<input type="text" name="cheque_date" value="{$cheque_date}" readonly placeholder="Cheque Date" style="width: 100%;">
        							<span class="add-on"><i class="icon-remove"></i></span>
									<span class="add-on"><i class="icon-th"></i></span>
    							</div>
								<input type="hidden" id="dtp_input1" value="" />
						...
						<div class="col-lg-2">
		                    <div class="form-group" style="visibility:visible;">
    							<div class="controls input-append date form_datetime" data-date-format="yyyy-mm-dd" data-link-field="dtp_input1">
        							<input type="text" name="dep_date" value="{$dep_date}" readonly placeholder="Deposited Date" style="width: 100%;">
        							<span class="add-on"><i class="icon-remove"></i></span>
									<span class="add-on"><i class="icon-th"></i></span>
    							</div>
								<input type="hidden" id="dtp_input1" value="" />
					...
					<div class="panel panel-yellow">
                		...
                		<div class="panel-body">
							<div class="col-lg-2">
		                    	<div class="form-group" style="visibility:visible;">
    								<div class="controls input-append date form_date" data-date-format="yyyy-mm-dd" data-link-field="dtp_input1">
        								<input type="text" name="date" value="{$date}" required placeholder="Date" style="width: 100%;">
        								<span class="add-on"><i class="icon-remove"></i></span>
										<span class="add-on"><i class="icon-th"></i></span>
    								</div>
									<input type="hidden" id="dtp_input1" value="" />
							...
							<div class="col-lg-2">
								<div class="form-group">
									<input class="btn btn-danger" type="submit" name="ok" value="Save paybill" />
								</div>                 
                    		</div>
						</div>
					</div>
