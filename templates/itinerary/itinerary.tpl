            			...
            			<div class="col-lg-3">
		                    <div class="form-group">
    							<div class="controls input-append date form_date" data-date-format="yyyy-mm-dd" data-link-field="dtp_input1">
        							<input type="text" name="submit_date" placeholder="Submitting Date" value="{$submit_date}" required="required" style="width: 100%;" onclick="findTotalInfant(); findTotalChild(); findTotalAdult();">
	            	...
	            	<div class="row" style="margin-top: 20px;">
		                ...
		                <div class="col-lg-2">
		                    <div class="form-group">
    							<div class="controls input-append date form_datetime" data-date-format="yyyy-mm-dd h:i:s" data-link-field="dtp_input1">
        							<input type="text" name="dep_time" value="{$dep_time}" required placeholder="Departure Time" style="width: 100%;">
        							<span class="add-on"><i class="icon-remove"></i></span>
									<span class="add-on"><i class="icon-th"></i></span>
    							</div>
								<input type="hidden" id="dtp_input1" value="" />
						...
						<div class="col-lg-2">
		                    <div class="form-group" id="returnDate" style="visibility:visible;">
    							<div class="controls input-append date form_datetime" data-date-format="yyyy-mm-dd h:i:s" data-link-field="dtp_input1">
        							<input type="text" name="arr_time" value="{$arr_time}" readonly placeholder="Arrvial Time" style="width: 100%;">
        							<span class="add-on"><i class="icon-remove"></i></span>
									<span class="add-on"><i class="icon-th"></i></span>
    							</div>
								<input type="hidden" id="dtp_input1" value="" />
				 ...
				 {if $passenger_total_updated < $passenger_total} 
            		...
            		<form name="add_product" action="itinerary.php?job=complete" method="post">
						<div class="row" style="margin-top: 20px;">
							...
							<div class="col-lg-3">
		                    	<div class="form-group">
									<button type="submit" name="ok" value="Save" class="btn btn-danger">Complete Itinerary</button>
								</div>
		                	</div>
	                	</div>
					</form>
