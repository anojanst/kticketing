    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    <a href="#"><i class="fa fa-calendar-o"></i><span>To Do List </span>
                ...
                <li class="treeview">
                    <a href="#"><i class="fa fa-university"></i><span> Bank</span>
                        <span class="pull-right-container">
			            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                ...
                <li class="treeview">
                    <a href="#"><i class="fa fa-space-shuttle"></i><span>Booking </span>
                        <span class="pull-right-container">
			            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                ...
                <li class="treeview">
                    <a href="#"><i class="fa fa-taxi"></i><span>Cab </span>
                        <span class="pull-right-container">
			            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
