			...
			<div class="panel panel-green" style="margin-top: 10px;">
                ...
                <div class="panel-body">
            		<form name="add_product" action="telephone_directory.php?job=add" method="post" enctype="multipart/form-data">
							...
							<div class="col-lg-3">
		                    	<div class="form-group" style="width: 100%;">
									<input style="width: 100%;" class="form-control" type="text" name="telephone_no" value="{$telephone_no}" placeholder="telephoneno"/>
		                   	 	</div>
		                	</div>
						...
						<div class="col-lg-2">
		                    <div class="form-group" id="returnDate" style="visibility:visible;">
    							<div class="controls input-append date form_date" data-date-format="yyyy-mm-dd" data-link-field="dtp_input1">
        							<input type="text" name="date" readonly placeholder="date" style="width: 100%;">
