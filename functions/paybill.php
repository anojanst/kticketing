	...
	if (check_access ( $module_no, $_SESSION ['user_id'] ) == 1) {
		...
		elseif ($_REQUEST ['job'] == "save_paybill") {
			...
			if (check_paybill_voucher ( $random_no ) == 1) {
				...
				save_paybill ( $paybill_no, $customer_name, $date, $remarks, $cheque_amount, $cheque_no, $cheque_bank, $cheque_branch, $cheque_date, $card_amount, $card_bank, $card_no, $exp_date, $bank, $from_bank, $dep_amount, $dep_date, $with_no, $mobile, $ref_no, $ez_amount, $cash_amount, $total, $saved_by );
