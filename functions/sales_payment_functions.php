...
function list_sales_of_customer($customer_name) {
	...
	while ( $row = mysqli_fetch_array ( $result, MYSQLI_ASSOC ) ) {
		...
		echo "
				...
				<td align='right' class='warning'>$row[paid]</td>
			
				<td align='right' class='success'>$row[due]</td>
...
function list_sales_payment_search($sales_payment_no_search, $customer_search) {
	...
	<tbody valign="top">';
		...
		<tr>
			...
			<td align="right" class="success">' . $row [cash_amount] . '</td>
			
			<td align="right" class="warning">' . $row [cheque_amount] . '</td>
