...
define ( 'DBUSER', 'cnnpgrou_doit' );
define ( 'DBPASS', 'doitoffice' );
define ( 'DBNAME', 'cnnpgrou_doit' );
...
EOD;
	...
	$sql = "insert into chat (chat.from,chat.to,message,sent) values ('" . mysql_real_escape_string ( $from ) . "', '" . mysql_real_escape_string ( $to ) . "','" . mysql_real_escape_string ( $message ) . "','$time')";
	$query = mysql_query ( $sql );
	echo "1";
	exit ( 0 );
}
